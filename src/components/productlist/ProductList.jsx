        ...
        {products.map((product) => (
          ...
          >
            ...
            <div className="flex justify-center mt-auto">
              ...
              <button
                className="inline-block text-white bg-black border hover:bg-white hover:text-[#000000] border-black hover:border-black px-6 py-1 rounded-full transition duration-300 ease-in-out cursor-pointer"
